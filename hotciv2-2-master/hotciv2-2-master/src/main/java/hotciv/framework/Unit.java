...
public interface Unit {
  ...
  /** returns whether this unit is fortified or not, using the FortifyState enum.
   * @return FortifyState.IsFortified if unit is fortified; otherwise return FortifyState.NotFortified.
   */
  FortifyState getFortifiedState();
  
  /** return the maximum travel distance of this unit
   * @return maximum travel distance of this unit
   */
  int getMaxTravelDistance();
}
